...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(loginService, snack, route) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function login() {
          ...
          this.loginService.postLogin(this.username, this.password).subscribe(function (res) {
            window.localStorage.setItem('token', res.token);

            _this.snack.open('Login Successful', 'OK', {
              duration: 2000
            });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _content_content_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    ...
    var _auth_interceptor__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./auth-interceptor */
    ...
    var routes = [{
      ...
      path: 'explore',
      component: _content_content_component__WEBPACK_IMPORTED_MODULE_16__["ContentComponent"]
    }, {
      path: '**',
      component: _error_error_component__WEBPACK_IMPORTED_MODULE_22__["ErrorComponent"]
    }];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _content_content_component__WEBPACK_IMPORTED_MODULE_16__["ContentComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_21__["HomeComponent"], _error_error_component__WEBPACK_IMPORTED_MODULE_22__["ErrorComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_13__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_14__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_15__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_17__["MatListModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_19__["MatDividerModule"], _angular_router__WEBPACK_IMPORTED_MODULE_20__["RouterModule"].forRoot(routes), _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_23__["ZXingScannerModule"]],
      providers: [{
        ...
        value: function intercept(request, next) {
          if (!request.url.endsWith('/authenticate')) {
            request = request.clone({
              setHeaders: {
                Authorization: "Bearer ".concat(this.login.getToken())
              }
            });
          }
      ...
      _createClass(ContentService, [{
        ...
        value: function getContent() {
          return this.http.get('http://localhost:8080/content/all', {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Authorization', 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJwcmFuYXYiLCJleHAiOjE1Nzk1MzY4MjYsImlhdCI6MTU3OTUxODgyNn0.a5bRam9HwapdNdXj_t1p0GuSgqkizX6xb11keNEmFD1a1tu-moLKmUVwmE5HcB4WCC171ShxHVyApSbtZ3PQNg')
          });
        }
      }, {
        key: "postLike",
        value: function postLike(contentId) {
    ...
    function () {
      ...
      _createClass(ContentComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.contentService.getContent().subscribe(function (res) {
            _this2.contentList = res;
          });
        }
      }, {
        key: "like",
        value: function like(contentId) {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _zxing_library__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(_zxing_library__WEBPACK_IMPORTED_MODULE_3__);
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(loginService, snack) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.loginService.postLogin(this.username, this.password).subscribe(function (res) {
            ...
            _this3.snack.open('Login Successful', 'OK', {
              duration: 2000
            });
          });
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Projects\Spring\ark\ark\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
